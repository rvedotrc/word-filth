...
class GivenEnglishQuestion implements Question<T, C> {
    ...
    public readonly vocabSources: AdverbiumVocabEntry[];

    constructor(lang: VocabLanguage.Type, englishQuestion: string, danishAnswers: string[], vocabSources: AdverbiumVocabEntry[]) {
        this.lang = lang;
        ...
        this.resultsKey = `vocab-adverbium-${encode(englishQuestion)}-GivenEnglish`;
