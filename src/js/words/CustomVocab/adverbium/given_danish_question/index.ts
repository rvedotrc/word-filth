...
class GivenDanishQuestion implements Question<T, C> {
    ...
    constructor(lang: VocabLanguage.Type, danishQuestion: string, englishAnswers: string[], vocabSources: AdverbiumVocabEntry[]) {
        this.lang = lang;
        ...
        this.resultsKey = `vocab-adverbium-${encode(danishQuestion)}-GivenDanish`;
        // TODO: particle
